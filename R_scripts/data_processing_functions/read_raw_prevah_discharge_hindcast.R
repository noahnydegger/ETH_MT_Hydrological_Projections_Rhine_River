...
input_dir <- file.path(home_dir, "Data", "Rhein", "raw_prevah_output", "routing")
output_dir <- file.path(home_dir, "Data", "Rheinblick2027", "processed_prevah_output")

input_file_name < "Swissrhine200_CTRL_RUN_WSL_F_2021_g73.dat"

output_file_name <- "prevah_discharge_hindcast"
